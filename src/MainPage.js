...
class MainPage extends Component {
  ...
  componentDidMount() {
    ...
    stations.forEach(result => {
      ...
      result.confirmCount = stories.filter(
        story => story.code === result.Code && story.status === 1
      ).length;
      result.reviewCount = stories.filter(
        story => story.code === result.Code && story.status === 0
      ).length;
      result.fakeCount = stories.filter(
        story => story.code === result.Code && story.status === 2
      ).length;
    });
...
var stories = [
  ...
  },
  {
    code: "E02",
    message:
      "1 injured, 2 sought after shooting at Shaw-Howard U Metro station| WTO https://wtop.com/dc/2019/07/1-injured-2-sought-after-shooting-at-shaw-howard-u-metro-station/          #SmartNews #bringit33",
    status: 1,
  ...
  },
  {
    code: "E02",
    message:
      "#BREAKING Man shot at Shaw-Howard University Metro Station at 1:12pm. He is conscious and breathing. Witnesses say the victim walked from the metro station to the 700 block of T st NW. #MPD #MetroTransitPD",
    status: 1,
  ...
  },
  {
    code: "E02",
    message:
      "UPDATED: Yellow/Green Line Alert: Shaw-Howard's 7th St entrance is closed due to a police investigation. The 8th St entrance remains open",
    status: 1,
  ...
  },
  {
    code: "E02",
    message:
      "somebody just got shot at Shaw-Howard station. I ain't never ran so fast in my life. It's too hot",
    status: 0,
